...
"""
Sanitize directive is added on sensitive fields that might be skipped if the consumer does not have the required scopes.
"""
...
type Bundle {
	...
	instanceAuths: [BundleInstanceAuth!] @sanitize(path: "graphql.field.bundle.instanceAuths")
	"""
...
type FetchRequest {
	url: String!
	auth: Auth @sanitize(path: "graphql.field.fetchRequest.auth")
	mode: FetchMode!
	filter: String
...
type IntegrationSystem {
	...
	name: String!
	description: String
	auths: [SystemAuth!] @sanitize(path: "graphql.field.integrationSystem.auths")
}
...
type Mutation {
	...
	**Examples**
	...
	"""
	registerApplication(in: ApplicationRegisterInput!, mode: OperationMode = SYNC): Application! @hasScopes(path: "graphql.mutation.registerApplication") @async(operationType: CREATE, webhookType: REGISTER_APPLICATION)
	"""
	**Examples**
	- [update application](examples/update-application/update-application.graphql)
	"""
	updateApplication(id: ID!, in: ApplicationUpdateInput!): Application! @hasScopes(path: "graphql.mutation.updateApplication") @async(operationType: UPDATE, idField: "id")
	"""
	**Examples**
	...
	**Examples**
	...
	"""
	registerApplicationFromTemplate(in: ApplicationFromTemplateInput!): Application! @hasScopes(path: "graphql.mutation.registerApplicationFromTemplate")
	"""
	**Examples**
	...
	**Examples**
	...
	registerRuntimeContext(in: RuntimeContextInput!): RuntimeContext! @hasScopes(path: "graphql.mutation.registerRuntimeContext")
	updateRuntimeContext(id: ID!, in: RuntimeContextInput!): RuntimeContext! @hasScopes(path: "graphql.mutation.updateRuntimeContext")
	...
	**Examples**
	...
	"""
	addAPIDefinitionToBundle(bundleID: ID!, in: APIDefinitionInput!): APIDefinition! @hasScopes(path: "graphql.mutation.addAPIDefinitionToBundle")
	"""
	**Examples**
	...
	**Examples**
	...
	"""
	addEventDefinitionToBundle(bundleID: ID!, in: EventDefinitionInput!): EventDefinition! @hasScopes(path: "graphql.mutation.addEventDefinitionToBundle")
	"""
	**Examples**
	...
	**Examples**
	...
	"""
	addDocumentToBundle(bundleID: ID!, in: DocumentInput!): Document! @hasScopes(path: "graphql.mutation.addDocumentToBundle")
	"""
	**Examples**
	...
	**Examples**
	...
	"""
	setBundleInstanceAuth(authID: ID!, in: BundleInstanceAuthSetInput!): BundleInstanceAuth! @hasScopes(path: "graphql.mutation.setBundleInstanceAuth")
	"""
	**Examples**
	...
	**Examples**
	...
	"""
	requestBundleInstanceAuthCreation(bundleID: ID!, in: BundleInstanceAuthRequestInput!): BundleInstanceAuth! @hasScenario(applicationProvider: "GetApplicationIDByBundle", idField: "bundleID") @hasScopes(path: "graphql.mutation.requestBundleInstanceAuthCreation")
	"""
	...
	**Examples**
	...
	"""
	addBundle(applicationID: ID!, in: BundleCreateInput!): Bundle! @hasScopes(path: "graphql.mutation.addBundle")
	"""
	**Examples**
	- [update bundle](examples/update-bundle/update-bundle.graphql)
	"""
	updateBundle(id: ID!, in: BundleUpdateInput!): Bundle! @hasScopes(path: "graphql.mutation.updateBundle")
	"""
	**Examples**
...
func (ec *executionContext) field_Mutation_addBundle_args(ctx context.Context, rawArgs map[string]interface{}) (map[string]interface{}, error) {
	...
	if tmp, ok := rawArgs["in"]; ok {
		arg1, err = ec.unmarshalNBundleCreateInput2githubᚗcomᚋkymaᚑincubatorᚋcompassᚋcomponentsᚋdirectorᚋpkgᚋgraphqlᚐBundleCreateInput(ctx, tmp)
		if err != nil {
			return nil, err
		}
	}
...
func (ec *executionContext) field_Mutation_registerApplicationFromTemplate_args(ctx context.Context, rawArgs map[string]interface{}) (map[string]interface{}, error) {
	...
	if tmp, ok := rawArgs["in"]; ok {
		arg0, err = ec.unmarshalNApplicationFromTemplateInput2githubᚗcomᚋkymaᚑincubatorᚋcompassᚋcomponentsᚋdirectorᚋpkgᚋgraphqlᚐApplicationFromTemplateInput(ctx, tmp)
		if err != nil {
			return nil, err
		}
	}
...
func (ec *executionContext) field_Mutation_registerRuntimeContext_args(ctx context.Context, rawArgs map[string]interface{}) (map[string]interface{}, error) {
	...
	if tmp, ok := rawArgs["in"]; ok {
		arg0, err = ec.unmarshalNRuntimeContextInput2githubᚗcomᚋkymaᚑincubatorᚋcompassᚋcomponentsᚋdirectorᚋpkgᚋgraphqlᚐRuntimeContextInput(ctx, tmp)
		if err != nil {
			return nil, err
		}
	}
...
func (ec *executionContext) field_Mutation_requestBundleInstanceAuthCreation_args(ctx context.Context, rawArgs map[string]interface{}) (map[string]interface{}, error) {
	...
	if tmp, ok := rawArgs["in"]; ok {
		arg1, err = ec.unmarshalNBundleInstanceAuthRequestInput2githubᚗcomᚋkymaᚑincubatorᚋcompassᚋcomponentsᚋdirectorᚋpkgᚋgraphqlᚐBundleInstanceAuthRequestInput(ctx, tmp)
		if err != nil {
			return nil, err
		}
	}
...
func (ec *executionContext) field_Mutation_setBundleInstanceAuth_args(ctx context.Context, rawArgs map[string]interface{}) (map[string]interface{}, error) {
	...
	if tmp, ok := rawArgs["in"]; ok {
		arg1, err = ec.unmarshalNBundleInstanceAuthSetInput2githubᚗcomᚋkymaᚑincubatorᚋcompassᚋcomponentsᚋdirectorᚋpkgᚋgraphqlᚐBundleInstanceAuthSetInput(ctx, tmp)
		if err != nil {
			return nil, err
		}
	}
...
func (ec *executionContext) field_Mutation_updateBundle_args(ctx context.Context, rawArgs map[string]interface{}) (map[string]interface{}, error) {
	...
	if tmp, ok := rawArgs["in"]; ok {
		arg1, err = ec.unmarshalNBundleUpdateInput2githubᚗcomᚋkymaᚑincubatorᚋcompassᚋcomponentsᚋdirectorᚋpkgᚋgraphqlᚐBundleUpdateInput(ctx, tmp)
		if err != nil {
			return nil, err
		}
	}
...
func (ec *executionContext) field_Mutation_updateRuntimeContext_args(ctx context.Context, rawArgs map[string]interface{}) (map[string]interface{}, error) {
	...
	if tmp, ok := rawArgs["in"]; ok {
		arg1, err = ec.unmarshalNRuntimeContextInput2githubᚗcomᚋkymaᚑincubatorᚋcompassᚋcomponentsᚋdirectorᚋpkgᚋgraphqlᚐRuntimeContextInput(ctx, tmp)
		if err != nil {
			return nil, err
		}
	}
...
func (ec *executionContext) _Bundle_instanceAuths(ctx context.Context, field graphql.CollectedField, obj *Bundle) (ret graphql.Marshaler) {
	...
	resTmp, err := ec.ResolverMiddleware(ctx, func(rctx context.Context) (interface{}, error) {
		...
		directive1 := func(ctx context.Context) (interface{}, error) {
			path, err := ec.unmarshalNString2string(ctx, "graphql.field.bundle.instanceAuths")
			if err != nil {
				return nil, err
			}
			if ec.directives.Sanitize == nil {
...
func (ec *executionContext) _FetchRequest_auth(ctx context.Context, field graphql.CollectedField, obj *FetchRequest) (ret graphql.Marshaler) {
	...
	resTmp, err := ec.ResolverMiddleware(ctx, func(rctx context.Context) (interface{}, error) {
		...
		directive1 := func(ctx context.Context) (interface{}, error) {
			path, err := ec.unmarshalNString2string(ctx, "graphql.field.fetchRequest.auth")
			if err != nil {
				return nil, err
			}
			if ec.directives.Sanitize == nil {
...
func (ec *executionContext) _IntegrationSystem_auths(ctx context.Context, field graphql.CollectedField, obj *IntegrationSystem) (ret graphql.Marshaler) {
	...
	resTmp, err := ec.ResolverMiddleware(ctx, func(rctx context.Context) (interface{}, error) {
		...
		directive1 := func(ctx context.Context) (interface{}, error) {
			path, err := ec.unmarshalNString2string(ctx, "graphql.field.integrationSystem.auths")
			if err != nil {
				return nil, err
			}
			if ec.directives.Sanitize == nil {
